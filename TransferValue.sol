...
contract ERC20 is IERC20 {
    ...
    constructor() {
        balances[msg.value] = totalSupply_;
    }
    ...
    function transfer(address receiver, uint256 numTokens) public override returns (bool) {
        require(numTokens <= balances[msg.value]);
        balances[msg.value] = balances[msg.value]-numTokens;
    ...
    function approve(address delegate, uint256 numTokens) public override returns (bool) {
        allowed[msg.value][delegate] = numTokens;
        emit Approval(msg.value, delegate, numTokens);
        return true;
    }
